...
struct HgemmFP16ExtremeMegaTile {
  ...
  using ProcessorGroupShape = cute::Shape<cute::_2, cute::_1, cute::_1>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmFP16ExtremeMegaTile::Gemm;
  using StrideA = typename HgemmFP16ExtremeMegaTile::StrideA;
  using StrideB = typename HgemmFP16ExtremeMegaTile::StrideB;
  using StrideC = typename HgemmFP16ExtremeMegaTile::StrideC;
  using StrideD = typename HgemmFP16ExtremeMegaTile::StrideD;
  using ElementA = typename HgemmFP16ExtremeMegaTile::ElementA;
  using ElementB = typename HgemmFP16ExtremeMegaTile::ElementB;
  using ElementC = typename HgemmFP16ExtremeMegaTile::ElementC;
  using ElementCompute = typename HgemmFP16ExtremeMegaTile::ElementCompute;
