...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm     = typename HgemmFP16FastAccum::Gemm;
  using StrideA  = typename HgemmFP16FastAccum::StrideA;
  using StrideB  = typename HgemmFP16FastAccum::StrideB;
  using StrideC  = typename HgemmFP16FastAccum::StrideC;
  using StrideD  = typename HgemmFP16FastAccum::StrideD;
  using ElementA = typename HgemmFP16FastAccum::ElementA;
  using ElementB = typename HgemmFP16FastAccum::ElementB;
  using ElementC = typename HgemmFP16FastAccum::ElementC;
