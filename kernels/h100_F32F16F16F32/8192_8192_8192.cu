...
struct HgemmH100TMAMulticastOptimized {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = HgemmH100TMAMulticastOptimized::Gemm;
  using StrideA = HgemmH100TMAMulticastOptimized::StrideA;
  using StrideB = HgemmH100TMAMulticastOptimized::StrideB;
  using StrideC = HgemmH100TMAMulticastOptimized::StrideC;
  using StrideD = HgemmH100TMAMulticastOptimized::StrideD;
  using ElementA = HgemmH100TMAMulticastOptimized::ElementA;
  using ElementB = HgemmH100TMAMulticastOptimized::ElementB;
  using ElementC = HgemmH100TMAMulticastOptimized::ElementC;
