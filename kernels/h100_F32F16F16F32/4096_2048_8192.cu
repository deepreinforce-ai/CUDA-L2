...
struct ProvenBestFP16HgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = ProvenBestFP16HgemmKernel::Gemm;
  using StrideA = ProvenBestFP16HgemmKernel::StrideA;
  using StrideB = ProvenBestFP16HgemmKernel::StrideB;
  using StrideC = ProvenBestFP16HgemmKernel::StrideC;
  using StrideD = ProvenBestFP16HgemmKernel::StrideD;
  using ElementA = ProvenBestFP16HgemmKernel::ElementA;
  using ElementB = ProvenBestFP16HgemmKernel::ElementB;
  using ElementC = ProvenBestFP16HgemmKernel::ElementC;
  using ElementCompute = ProvenBestFP16HgemmKernel::ElementCompute;
