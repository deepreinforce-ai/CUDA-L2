...
__global__ void __launch_bounds__(256, 1) hgemm_ultra_deep_pipeline_kernel(
...
void launch_hgemm_ultra_deep_pipeline(T *a, T *b, T *c, int M, int N, int K,
                                       int swizzle_stride) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      hgemm_ultra_deep_pipeline_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA,
  ...
  hgemm_ultra_deep_pipeline_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA, G2SCopyB,
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_ultra_deep_pipeline<half, stages, swizzle>(
