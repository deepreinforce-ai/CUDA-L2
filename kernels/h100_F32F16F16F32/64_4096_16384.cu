...
hgemm_optimized_pipeline_kernel(const T * __restrict__ Aptr,
...
void launch_hgemm_pipeline(T *a, T *b, T *c, int M, int N, int K) {
    using namespace cute;
    ...
    cudaFuncSetAttribute(
        hgemm_optimized_pipeline_kernel<T, BM, BN, BK, Stages, MMA,
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
    ...
    launch_hgemm_pipeline<half, 8>(a_ptr, b_col_ptr, c_ptr, M, N, K);
}