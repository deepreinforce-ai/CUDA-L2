...
struct OptimizedThreeStageHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = OptimizedThreeStageHgemmKernel::Gemm;
  using StrideA = OptimizedThreeStageHgemmKernel::StrideA;
  using StrideB = OptimizedThreeStageHgemmKernel::StrideB;
  using StrideC = OptimizedThreeStageHgemmKernel::StrideC;
  using StrideD = OptimizedThreeStageHgemmKernel::StrideD;
  using ElementA = OptimizedThreeStageHgemmKernel::ElementA;
  using ElementB = OptimizedThreeStageHgemmKernel::ElementB;
  using ElementC = OptimizedThreeStageHgemmKernel::ElementC;
