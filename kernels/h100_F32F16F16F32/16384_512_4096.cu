...
struct HgemmPriorityEpilogueOptimized {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = HgemmPriorityEpilogueOptimized::Gemm;
  using StrideA = HgemmPriorityEpilogueOptimized::StrideA;
  using StrideB = HgemmPriorityEpilogueOptimized::StrideB;
  using StrideC = HgemmPriorityEpilogueOptimized::StrideC;
  using StrideD = HgemmPriorityEpilogueOptimized::StrideD;
  using ElementA = HgemmPriorityEpilogueOptimized::ElementA;
  using ElementB = HgemmPriorityEpilogueOptimized::ElementB;
  using ElementC = HgemmPriorityEpilogueOptimized::ElementC;
