...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  if (status != cutlass::Status::kSuccess) {
    std::string err_msg = "CUTLASS GEMM cannot implement this configuration.\n";
    err_msg += "Problem: M=" + std::to_string(M) + ", N=" + std::to_string(N) + ", K=" + std::to_string(K) + "\n";
    err_msg += "Tile: 256x256x64, Grid: 2x1x1, FP16 accumulation\n";
