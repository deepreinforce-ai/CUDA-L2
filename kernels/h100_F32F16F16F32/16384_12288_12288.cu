...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename HgemmExplicit3Stage::Gemm;
  using StrideA = typename HgemmExplicit3Stage::StrideA;
  using StrideB = typename HgemmExplicit3Stage::StrideB;
  using StrideC = typename HgemmExplicit3Stage::StrideC;
  using StrideD = typename HgemmExplicit3Stage::StrideD;
  using ElementA = typename HgemmExplicit3Stage::ElementA;
  using ElementB = typename HgemmExplicit3Stage::ElementB;
  using ElementC = typename HgemmExplicit3Stage::ElementC;
...
#else
  throw std::runtime_error("CUTLASS SM90 not supported - requires H100 or newer GPU");
#endif
}