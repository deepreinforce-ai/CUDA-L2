...
hgemm_optimized_final_kernel(T *Aptr, T *Bptr, T *Dptr, int m, int n, int k) {
...
void launch_hgemm_optimized_final(T *a, T *b, T *c, int M, int N, int K) {
  ...
  cudaFuncSetAttribute(
      hgemm_optimized_final_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA,
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  launch_hgemm_optimized_final<half, 6>(
