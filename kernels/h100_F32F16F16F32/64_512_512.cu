...
hgemm_kernel_bk128_5stage(T * __restrict__ Aptr, T * __restrict__ Bptr,
...
void launch_hgemm_bk128_5stage(T *a, T *b, T *c, int M, int N, int K,
                                int swizzle_stride) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      hgemm_kernel_bk128_5stage<T, BM, BN, BK, KStage, MMA,
                                 G2SCopyA, G2SCopyB,
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_bk128_5stage<half, 5, true>(
