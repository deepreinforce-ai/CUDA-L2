...
struct InvertedTileHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = InvertedTileHgemmKernel::Gemm;
  using StrideA = InvertedTileHgemmKernel::StrideA;
  using StrideB = InvertedTileHgemmKernel::StrideB;
  using StrideC = InvertedTileHgemmKernel::StrideC;
  using StrideD = InvertedTileHgemmKernel::StrideD;
  using ElementA = InvertedTileHgemmKernel::ElementA;
  using ElementB = InvertedTileHgemmKernel::ElementB;
  using ElementC = InvertedTileHgemmKernel::ElementC;
