...
struct ExplicitFourStagePrimaryHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename ExplicitFourStagePrimaryHgemmKernel::Gemm;
  using StrideA = typename ExplicitFourStagePrimaryHgemmKernel::StrideA;
  using StrideB = typename ExplicitFourStagePrimaryHgemmKernel::StrideB;
  using StrideC = typename ExplicitFourStagePrimaryHgemmKernel::StrideC;
  using StrideD = typename ExplicitFourStagePrimaryHgemmKernel::StrideD;
  using ElementA = typename ExplicitFourStagePrimaryHgemmKernel::ElementA;
  using ElementB = typename ExplicitFourStagePrimaryHgemmKernel::ElementB;
  using ElementC = typename ExplicitFourStagePrimaryHgemmKernel::ElementC;
