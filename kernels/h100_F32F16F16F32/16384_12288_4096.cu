...
struct TiledWaveOptimizedKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename TiledWaveOptimizedKernel::Gemm;
  using StrideA = typename TiledWaveOptimizedKernel::StrideA;
  using StrideB = typename TiledWaveOptimizedKernel::StrideB;
  using StrideC = typename TiledWaveOptimizedKernel::StrideC;
  using StrideD = typename TiledWaveOptimizedKernel::StrideD;
  using ElementA = typename TiledWaveOptimizedKernel::ElementA;
  using ElementB = typename TiledWaveOptimizedKernel::ElementB;
  using ElementC = typename TiledWaveOptimizedKernel::ElementC;
