...
struct HgemmWarpGroupCooperative {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmWarpGroupCooperative::Gemm;
  using StrideA = typename HgemmWarpGroupCooperative::StrideA;
  using StrideB = typename HgemmWarpGroupCooperative::StrideB;
  using StrideC = typename HgemmWarpGroupCooperative::StrideC;
  using StrideD = typename HgemmWarpGroupCooperative::StrideD;
  using ElementA = typename HgemmWarpGroupCooperative::ElementA;
  using ElementB = typename HgemmWarpGroupCooperative::ElementB;
  using ElementC = typename HgemmWarpGroupCooperative::ElementC;
