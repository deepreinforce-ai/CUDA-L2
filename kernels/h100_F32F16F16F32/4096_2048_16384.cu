...
struct HgemmEnhancedVectorization {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  using Gemm = HgemmEnhancedVectorization::Gemm;
  using StrideA = HgemmEnhancedVectorization::StrideA;
  using StrideB = HgemmEnhancedVectorization::StrideB;
  using StrideC = HgemmEnhancedVectorization::StrideC;
  using StrideD = HgemmEnhancedVectorization::StrideD;
  using ElementA = HgemmEnhancedVectorization::ElementA;
  using ElementB = HgemmEnhancedVectorization::ElementB;
  using ElementC = HgemmEnhancedVectorization::ElementC;
