...
struct HgemmUltraWideTileKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmUltraWideTileKernel::Gemm;
  using StrideA = typename HgemmUltraWideTileKernel::StrideA;
  using StrideB = typename HgemmUltraWideTileKernel::StrideB;
  using StrideC = typename HgemmUltraWideTileKernel::StrideC;
  using StrideD = typename HgemmUltraWideTileKernel::StrideD;
  using ElementA = typename HgemmUltraWideTileKernel::ElementA;
  using ElementB = typename HgemmUltraWideTileKernel::ElementB;
  using ElementC = typename HgemmUltraWideTileKernel::ElementC;
