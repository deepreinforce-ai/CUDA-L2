...
__global__ void __launch_bounds__(256, 2)
    hgemm_enhanced_scheduling_kernel(T *Aptr, T *Bptr, T *Dptr, int m, int n, int k) {
...
void launch_hgemm_enhanced(T *a, T *b, T *c, int M, int N, int K) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      hgemm_enhanced_scheduling_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA, G2SCopyB,
