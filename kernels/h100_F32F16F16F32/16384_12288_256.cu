...
struct EpilogueOptimizedHgemmKernel {
  ...
  using EpilogueTileShape = cute::Shape<cute::_64, cute::_64>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename EpilogueOptimizedHgemmKernel::Gemm;
  using StrideA = typename EpilogueOptimizedHgemmKernel::StrideA;
  using StrideB = typename EpilogueOptimizedHgemmKernel::StrideB;
  using StrideC = typename EpilogueOptimizedHgemmKernel::StrideC;
  using StrideD = typename EpilogueOptimizedHgemmKernel::StrideD;
  using ElementA = typename EpilogueOptimizedHgemmKernel::ElementA;
  using ElementB = typename EpilogueOptimizedHgemmKernel::ElementB;
  using ElementC = typename EpilogueOptimizedHgemmKernel::ElementC;
