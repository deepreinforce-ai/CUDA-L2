...
hgemm_optimized_pipeline_kernel(T *Aptr, T *Bptr, T *Dptr, int m, int n, int k) {
...
void launch_hgemm_optimized_pipeline(T *a, T *b, T *c, int M, int N, int K,
                                      int swizzle_stride) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      hgemm_optimized_pipeline_kernel<
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  launch_hgemm_optimized_pipeline<half, stages, true>(
