...
struct HgemmTransposedOptimized {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename HgemmTransposedOptimized::Gemm;
  using StrideA = typename HgemmTransposedOptimized::StrideA;
  using StrideB = typename HgemmTransposedOptimized::StrideB;
  using StrideC = typename HgemmTransposedOptimized::StrideC;
  using StrideD = typename HgemmTransposedOptimized::StrideD;
  using ElementA = typename HgemmTransposedOptimized::ElementA;
  using ElementB = typename HgemmTransposedOptimized::ElementB;
  using ElementC = typename HgemmTransposedOptimized::ElementC;
