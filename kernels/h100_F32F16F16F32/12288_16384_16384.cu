...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmTransposedTile::Gemm;
  using StrideA = typename HgemmTransposedTile::StrideA;
  using StrideB = typename HgemmTransposedTile::StrideB;
  using StrideC = typename HgemmTransposedTile::StrideC;
  using StrideD = typename HgemmTransposedTile::StrideD;
  using ElementA = typename HgemmTransposedTile::ElementA;
  using ElementB = typename HgemmTransposedTile::ElementB;
  using ElementC = typename HgemmTransposedTile::ElementC;
