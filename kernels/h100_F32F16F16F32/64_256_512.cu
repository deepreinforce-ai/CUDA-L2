...
template <typename T>
void launch_hgemm_optimized_grid_tn_cute(T *a, T *b, T *c, int M,
  ...
  cudaFuncSetAttribute(
      cuda_l2_h100_fp32_kernel<
          T, BM, BN, BK, Stages, MMA, G2SCopyA, G2SCopyB, SmemLayoutA,
  ...
  cuda_l2_h100_fp32_kernel<
      T, BM, BN, BK, Stages, MMA, G2SCopyA, G2SCopyB, SmemLayoutA, SmemLayoutB,
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_optimized_grid_tn_cute<half>(
