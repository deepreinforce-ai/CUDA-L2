...
struct EnhancedCooperativeHgemm {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename EnhancedCooperativeHgemm::Gemm;
  using StrideA = typename EnhancedCooperativeHgemm::StrideA;
  using StrideB = typename EnhancedCooperativeHgemm::StrideB;
  using StrideC = typename EnhancedCooperativeHgemm::StrideC;
  using StrideD = typename EnhancedCooperativeHgemm::StrideD;
  using ElementA = typename EnhancedCooperativeHgemm::ElementA;
  using ElementB = typename EnhancedCooperativeHgemm::ElementB;
  using ElementC = typename EnhancedCooperativeHgemm::ElementC;
