...
struct AutoStageCarveoutHgemmConfig {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename AutoStageCarveoutHgemmConfig::Gemm;
  using StrideA = typename AutoStageCarveoutHgemmConfig::StrideA;
  using StrideB = typename AutoStageCarveoutHgemmConfig::StrideB;
  using StrideC = typename AutoStageCarveoutHgemmConfig::StrideC;
  using StrideD = typename AutoStageCarveoutHgemmConfig::StrideD;
  using ElementA = typename AutoStageCarveoutHgemmConfig::ElementA;
  using ElementB = typename AutoStageCarveoutHgemmConfig::ElementB;
  using ElementC = typename AutoStageCarveoutHgemmConfig::ElementC;
