...
struct TMAMulticastSwizzledKernel {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = TMAMulticastSwizzledKernel::Gemm;
  using StrideA = TMAMulticastSwizzledKernel::StrideA;
  using StrideB = TMAMulticastSwizzledKernel::StrideB;
  using StrideC = TMAMulticastSwizzledKernel::StrideC;
  using StrideD = TMAMulticastSwizzledKernel::StrideD;
  using ElementA = TMAMulticastSwizzledKernel::ElementA;
  using ElementB = TMAMulticastSwizzledKernel::ElementB;
  using ElementC = TMAMulticastSwizzledKernel::ElementC;
