...
struct HgemmAsymmetricExplicit4Stage {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = HgemmAsymmetricExplicit4Stage::Gemm;
  using StrideA = HgemmAsymmetricExplicit4Stage::StrideA;
  using StrideB = HgemmAsymmetricExplicit4Stage::StrideB;
  using StrideC = HgemmAsymmetricExplicit4Stage::StrideC;
  using StrideD = HgemmAsymmetricExplicit4Stage::StrideD;
  using ElementA = HgemmAsymmetricExplicit4Stage::ElementA;
  using ElementB = HgemmAsymmetricExplicit4Stage::ElementB;
  using ElementC = HgemmAsymmetricExplicit4Stage::ElementC;
