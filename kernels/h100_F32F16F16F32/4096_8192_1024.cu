...
struct EnhancedProductionHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = EnhancedProductionHgemmKernel::Gemm;
  using StrideA = EnhancedProductionHgemmKernel::StrideA;
  using StrideB = EnhancedProductionHgemmKernel::StrideB;
  using StrideC = EnhancedProductionHgemmKernel::StrideC;
  using StrideD = EnhancedProductionHgemmKernel::StrideD;
  using ElementA = EnhancedProductionHgemmKernel::ElementA;
  using ElementB = EnhancedProductionHgemmKernel::ElementB;
  using ElementC = EnhancedProductionHgemmKernel::ElementC;
