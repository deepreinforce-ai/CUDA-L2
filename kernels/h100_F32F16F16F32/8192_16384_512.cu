...
struct HgemmOptimizedPingpong {
  ...
  using MainloopStages = cutlass::gemm::collective::StageCount<3>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmOptimizedPingpong::Gemm;
  using StrideA = typename HgemmOptimizedPingpong::StrideA;
  using StrideB = typename HgemmOptimizedPingpong::StrideB;
  using StrideC = typename HgemmOptimizedPingpong::StrideC;
  using StrideD = typename HgemmOptimizedPingpong::StrideD;
  using ElementA = typename HgemmOptimizedPingpong::ElementA;
  using ElementB = typename HgemmOptimizedPingpong::ElementB;
  using ElementC = typename HgemmOptimizedPingpong::ElementC;
