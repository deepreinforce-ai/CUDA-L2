...
struct OptimizedPersistentHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = OptimizedPersistentHgemmKernel::Gemm;
  using StrideA = OptimizedPersistentHgemmKernel::StrideA;
  using StrideB = OptimizedPersistentHgemmKernel::StrideB;
  using StrideC = OptimizedPersistentHgemmKernel::StrideC;
  using StrideD = OptimizedPersistentHgemmKernel::StrideD;
  using ElementA = OptimizedPersistentHgemmKernel::ElementA;
  using ElementB = OptimizedPersistentHgemmKernel::ElementB;
  using ElementC = OptimizedPersistentHgemmKernel::ElementC;
