...
hgemm_8stage_ultradeep_kernel(T *Aptr, T *Bptr, T *Dptr, int m, int n, int k) {
...
void launch_hgemm_8stage_ultradeep(T *a, T *b, T *c, int M, int N, int K, int swizzle_stride) {
  using namespace cute;
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_8stage_ultradeep<half, 8, true>(
