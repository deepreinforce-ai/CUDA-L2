...
void gemm_wgmma_tma_safe_kernel(
    ...
    Alpha alpha, Beta beta)
{
  ...
  using SharedStorage = SharedStorageSafe<TA, TB, SmemLayoutA, SmemLayoutB>;
    ...
    int M, int N, int K)
{
  ...
  using SharedStorage = SharedStorageSafe<TA, TB, decltype(sA), decltype(sB)>;
  ...
  auto kernel_ptr = &gemm_wgmma_tma_safe_kernel<
    ...
    torch::Tensor c)
{
  ...
  launch_hgemm_safe<cute::half_t, cute::half_t, cute::half_t>(
