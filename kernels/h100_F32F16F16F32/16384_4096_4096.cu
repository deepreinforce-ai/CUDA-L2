...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmSwizzleOptimized::Gemm;
  using StrideA = typename HgemmSwizzleOptimized::StrideA;
  using StrideB = typename HgemmSwizzleOptimized::StrideB;
  using StrideC = typename HgemmSwizzleOptimized::StrideC;
  using StrideD = typename HgemmSwizzleOptimized::StrideD;
  using ElementA = typename HgemmSwizzleOptimized::ElementA;
  using ElementB = typename HgemmSwizzleOptimized::ElementB;
  using ElementC = typename HgemmSwizzleOptimized::ElementC;
