...
struct HgemmMemoryOptimizedKernel {
  ...
  using StageCountType = cutlass::gemm::collective::StageCountAutoCarveout<3>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = HgemmMemoryOptimizedKernel::Gemm;
  using StrideA = HgemmMemoryOptimizedKernel::StrideA;
  using StrideB = HgemmMemoryOptimizedKernel::StrideB;
  using StrideC = HgemmMemoryOptimizedKernel::StrideC;
  using StrideD = HgemmMemoryOptimizedKernel::StrideD;
  using ElementA = HgemmMemoryOptimizedKernel::ElementA;
  using ElementB = HgemmMemoryOptimizedKernel::ElementB;
  using ElementC = HgemmMemoryOptimizedKernel::ElementC;
