    ...
    Alpha alpha, Beta beta)
{
  ...
  using SharedStorage = SharedStorageStable<TA, TB, SmemLayoutA, SmemLayoutB>;
    ...
    int M, int N, int K)
{
  ...
  using SharedStorage = SharedStorageStable<TA, TB, decltype(sA), decltype(sB)>;
  ...
  auto kernel_ptr = &gemm_stable_kernel<
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_stable<cute::half_t, cute::half_t, cute::half_t>(
