...
struct CooperativeEpilogueKernel {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  using Gemm = typename CooperativeEpilogueKernel::Gemm;
  using StrideA = typename CooperativeEpilogueKernel::StrideA;
  using StrideB = typename CooperativeEpilogueKernel::StrideB;
  using StrideC = typename CooperativeEpilogueKernel::StrideC;
  using StrideD = typename CooperativeEpilogueKernel::StrideD;
  using ElementA = typename CooperativeEpilogueKernel::ElementA;
  using ElementB = typename CooperativeEpilogueKernel::ElementB;
  using ElementC = typename CooperativeEpilogueKernel::ElementC;
...
#else
  throw std::runtime_error("SM90 architecture required - H100 GPU needed");
#endif
}