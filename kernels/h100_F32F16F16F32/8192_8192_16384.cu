...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename HgemmVertical2x1::Gemm;
  using StrideA = typename HgemmVertical2x1::StrideA;
  using StrideB = typename HgemmVertical2x1::StrideB;
  using StrideC = typename HgemmVertical2x1::StrideC;
  using StrideD = typename HgemmVertical2x1::StrideD;
  using ElementA = typename HgemmVertical2x1::ElementA;
  using ElementB = typename HgemmVertical2x1::ElementB;
  using ElementC = typename HgemmVertical2x1::ElementC;
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
                                 torch::Tensor b_col_major, torch::Tensor c) {
  throw std::runtime_error("CUTLASS SM90 MMA not supported on this architecture - H100 GPU required");
}
