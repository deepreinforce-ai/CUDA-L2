...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmValidatedChampion::Gemm;
  using StrideA = typename HgemmValidatedChampion::StrideA;
  using StrideB = typename HgemmValidatedChampion::StrideB;
  using StrideC = typename HgemmValidatedChampion::StrideC;
  using StrideD = typename HgemmValidatedChampion::StrideD;
  using ElementA = typename HgemmValidatedChampion::ElementA;
  using ElementB = typename HgemmValidatedChampion::ElementB;
  using ElementC = typename HgemmValidatedChampion::ElementC;
