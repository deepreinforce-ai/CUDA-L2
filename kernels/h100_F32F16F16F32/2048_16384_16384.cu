...
struct UltimateMaxPipelineH100Hgemm {
  ...
  using CollectiveMainloop = typename cutlass::gemm::collective::CollectiveBuilder<
      ...
      ElementAccumulator,
      TileShape, WorkShape,
      cutlass::gemm::collective::StageCountAutoCarveout<6>,
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename UltimateMaxPipelineH100Hgemm::Gemm;
  using StrideA = typename UltimateMaxPipelineH100Hgemm::StrideA;
  using StrideB = typename UltimateMaxPipelineH100Hgemm::StrideB;
  using StrideC = typename UltimateMaxPipelineH100Hgemm::StrideC;
  using StrideD = typename UltimateMaxPipelineH100Hgemm::StrideD;
  using ElementA = typename UltimateMaxPipelineH100Hgemm::ElementA;
  using ElementB = typename UltimateMaxPipelineH100Hgemm::ElementB;
  using ElementC = typename UltimateMaxPipelineH100Hgemm::ElementC;
