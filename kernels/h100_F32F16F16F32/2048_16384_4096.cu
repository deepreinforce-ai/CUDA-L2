...
struct OptimizedStage4HgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename OptimizedStage4HgemmKernel::Gemm;
  using StrideA = typename OptimizedStage4HgemmKernel::StrideA;
  using StrideB = typename OptimizedStage4HgemmKernel::StrideB;
  using StrideC = typename OptimizedStage4HgemmKernel::StrideC;
  using StrideD = typename OptimizedStage4HgemmKernel::StrideD;
  using ElementA = typename OptimizedStage4HgemmKernel::ElementA;
  using ElementB = typename OptimizedStage4HgemmKernel::ElementB;
  using ElementC = typename OptimizedStage4HgemmKernel::ElementC;
