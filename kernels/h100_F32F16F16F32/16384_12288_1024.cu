...
__global__ void __launch_bounds__(128, 2) hgemm_bn160_optimized_kernel(
...
void launch_hgemm_bn160_optimized(T *a, T *b, T *c, int M, int N, int K,
                                   int swizzle_stride) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      hgemm_bn160_optimized_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA,
  ...
  hgemm_bn160_optimized_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA, G2SCopyB,
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_bn160_optimized<half, 3, true>(
