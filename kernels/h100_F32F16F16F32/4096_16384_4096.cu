...
struct Aggressive6StageHgemmKernel {
  ...
  using StageCountType = cutlass::gemm::collective::StageCountAutoCarveout<StageCount>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = Aggressive6StageHgemmKernel::Gemm;
  using StrideA = Aggressive6StageHgemmKernel::StrideA;
  using StrideB = Aggressive6StageHgemmKernel::StrideB;
  using StrideC = Aggressive6StageHgemmKernel::StrideC;
  using StrideD = Aggressive6StageHgemmKernel::StrideD;
  using ElementA = Aggressive6StageHgemmKernel::ElementA;
  using ElementB = Aggressive6StageHgemmKernel::ElementB;
  using ElementC = Aggressive6StageHgemmKernel::ElementC;
