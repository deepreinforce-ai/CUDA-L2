...
struct HgemmAsymmetricCooperativeH100 {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = HgemmAsymmetricCooperativeH100::Gemm;
  using StrideA = HgemmAsymmetricCooperativeH100::StrideA;
  using StrideB = HgemmAsymmetricCooperativeH100::StrideB;
  using StrideC = HgemmAsymmetricCooperativeH100::StrideC;
  using StrideD = HgemmAsymmetricCooperativeH100::StrideD;
  using ElementA = HgemmAsymmetricCooperativeH100::ElementA;
  using ElementB = HgemmAsymmetricCooperativeH100::ElementB;
  using ElementC = HgemmAsymmetricCooperativeH100::ElementC;
