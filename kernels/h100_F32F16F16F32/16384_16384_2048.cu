...
struct HgemmPrecisionOptimizedH100 {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmPrecisionOptimizedH100::Gemm;
  using StrideA = typename HgemmPrecisionOptimizedH100::StrideA;
  using StrideB = typename HgemmPrecisionOptimizedH100::StrideB;
  using StrideC = typename HgemmPrecisionOptimizedH100::StrideC;
  using StrideD = typename HgemmPrecisionOptimizedH100::StrideD;
  using ElementA = typename HgemmPrecisionOptimizedH100::ElementA;
  using ElementB = typename HgemmPrecisionOptimizedH100::ElementB;
  using ElementC = typename HgemmPrecisionOptimizedH100::ElementC;
