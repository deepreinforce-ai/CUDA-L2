...
__global__ void hgemm_enhanced_coalesce_kernel(T *Aptr, T *Bptr, T *Dptr,
                                               int m, int n, int k) {
...
void launch_hgemm_enhanced_coalesce(T *a, T *b, T *c, int M, int N, int K,
                                    int swizzle_stride) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      hgemm_enhanced_coalesce_kernel<
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  launch_hgemm_enhanced_coalesce<half, 4, true>(
