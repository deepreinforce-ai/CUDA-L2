...
struct MemoryOptimizedAutoCarveoutHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename MemoryOptimizedAutoCarveoutHgemmKernel::Gemm;
  using StrideA = typename MemoryOptimizedAutoCarveoutHgemmKernel::StrideA;
  using StrideB = typename MemoryOptimizedAutoCarveoutHgemmKernel::StrideB;
  using StrideC = typename MemoryOptimizedAutoCarveoutHgemmKernel::StrideC;
  using StrideD = typename MemoryOptimizedAutoCarveoutHgemmKernel::StrideD;
  using ElementA = typename MemoryOptimizedAutoCarveoutHgemmKernel::ElementA;
  using ElementB = typename MemoryOptimizedAutoCarveoutHgemmKernel::ElementB;
  using ElementC = typename MemoryOptimizedAutoCarveoutHgemmKernel::ElementC;
