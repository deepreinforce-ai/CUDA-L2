...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename HgemmStreamKFineK::Gemm;
  using StrideA = typename HgemmStreamKFineK::StrideA;
  using StrideB = typename HgemmStreamKFineK::StrideB;
  using StrideC = typename HgemmStreamKFineK::StrideC;
  using StrideD = typename HgemmStreamKFineK::StrideD;
  using ElementA = typename HgemmStreamKFineK::ElementA;
  using ElementB = typename HgemmStreamKFineK::ElementB;
  using ElementC = typename HgemmStreamKFineK::ElementC;
