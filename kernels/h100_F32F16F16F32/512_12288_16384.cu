...
struct DualOptimizedSafeKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename DualOptimizedSafeKernel::Gemm;
  using StrideA = typename DualOptimizedSafeKernel::StrideA;
  using StrideB = typename DualOptimizedSafeKernel::StrideB;
  using StrideC = typename DualOptimizedSafeKernel::StrideC;
  using StrideD = typename DualOptimizedSafeKernel::StrideD;
  using ElementA = typename DualOptimizedSafeKernel::ElementA;
  using ElementB = typename DualOptimizedSafeKernel::ElementB;
  using ElementC = typename DualOptimizedSafeKernel::ElementC;
