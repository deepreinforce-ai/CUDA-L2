...
hgemm_optimized_pipelined_kernel(const T* __restrict__ Aptr,
...
#pragma unroll
  ...
  auto sC = make_tensor(Ashm, SmemLayoutC{});
...
void launch_hgemm_optimized(const T* a, const T* b, T* c,
  ...
  auto kernel_ptr = &hgemm_optimized_pipelined_kernel<T, BM, BN, BK, MMA,
                                                      G2SCopyA, G2SCopyB,
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_optimized<half>(a_ptr, b_col_ptr, c_ptr, M, N, K);
}