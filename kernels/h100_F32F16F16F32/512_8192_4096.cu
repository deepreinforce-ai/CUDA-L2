...
struct SafeCacheOptimizedHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename SafeCacheOptimizedHgemmKernel::Gemm;
  using StrideA = typename SafeCacheOptimizedHgemmKernel::StrideA;
  using StrideB = typename SafeCacheOptimizedHgemmKernel::StrideB;
  using StrideC = typename SafeCacheOptimizedHgemmKernel::StrideC;
  using StrideD = typename SafeCacheOptimizedHgemmKernel::StrideD;
  using ElementA = typename SafeCacheOptimizedHgemmKernel::ElementA;
  using ElementB = typename SafeCacheOptimizedHgemmKernel::ElementB;
  using ElementC = typename SafeCacheOptimizedHgemmKernel::ElementC;
