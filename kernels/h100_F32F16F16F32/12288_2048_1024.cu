...
struct HgemmKernelBreakthrough {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = HgemmKernelBreakthrough::Gemm;
  using StrideA = HgemmKernelBreakthrough::StrideA;
  using StrideB = HgemmKernelBreakthrough::StrideB;
  using StrideC = HgemmKernelBreakthrough::StrideC;
  using StrideD = HgemmKernelBreakthrough::StrideD;
  using ElementA = HgemmKernelBreakthrough::ElementA;
  using ElementB = HgemmKernelBreakthrough::ElementB;
  using ElementC = HgemmKernelBreakthrough::ElementC;
