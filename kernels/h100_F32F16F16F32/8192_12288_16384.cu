...
using StageCountType = cutlass::gemm::collective::StageCountAutoCarveout<
    static_cast<int>(sizeof(typename cutlass::arch::ClusterTransactionBarrier::ValueType)) * 
    static_cast<int>(cutlass::sizeof_bits<ElementA>::value)
>;
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  if (status != cutlass::Status::kSuccess) {
    std::string err_msg = "CUTLASS GEMM configuration cannot implement: M=" + 
