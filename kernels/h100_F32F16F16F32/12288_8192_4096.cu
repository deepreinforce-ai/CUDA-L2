...
struct HgemmKernelConfig {
  ...
  using WarpGroupShape = cute::Shape<cute::_1, cute::_1, cute::_1>;
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename HgemmKernelConfig::Gemm;
  using StrideA = typename HgemmKernelConfig::StrideA;
  using StrideB = typename HgemmKernelConfig::StrideB;
  using StrideC = typename HgemmKernelConfig::StrideC;
  using StrideD = typename HgemmKernelConfig::StrideD;
  using ElementA = typename HgemmKernelConfig::ElementA;
  using ElementB = typename HgemmKernelConfig::ElementB;
  using ElementC = typename HgemmKernelConfig::ElementC;
