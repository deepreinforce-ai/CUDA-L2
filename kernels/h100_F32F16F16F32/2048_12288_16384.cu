...
struct ExplicitThreeStageHgemmKernel {
  ...
  using GridBlockShape = cute::Shape<cute::_2, cute::_1, cute::_1>;
  ...
  using StageCountType = cutlass::gemm::collective::StageCount<3>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename ExplicitThreeStageHgemmKernel::Gemm;
  using StrideA = typename ExplicitThreeStageHgemmKernel::StrideA;
  using StrideB = typename ExplicitThreeStageHgemmKernel::StrideB;
  using StrideC = typename ExplicitThreeStageHgemmKernel::StrideC;
  using StrideD = typename ExplicitThreeStageHgemmKernel::StrideD;
  using ElementA = typename ExplicitThreeStageHgemmKernel::ElementA;
  using ElementB = typename ExplicitThreeStageHgemmKernel::ElementB;
  using ElementC = typename ExplicitThreeStageHgemmKernel::ElementC;
