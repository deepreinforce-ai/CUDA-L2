...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = HgemmScaledNTile::Gemm;
  using StrideA = HgemmScaledNTile::StrideA;
  using StrideB = HgemmScaledNTile::StrideB;
  using StrideC = HgemmScaledNTile::StrideC;
  using StrideD = HgemmScaledNTile::StrideD;
  using ElementA = HgemmScaledNTile::ElementA;
  using ElementB = HgemmScaledNTile::ElementB;
  using ElementC = HgemmScaledNTile::ElementC;
