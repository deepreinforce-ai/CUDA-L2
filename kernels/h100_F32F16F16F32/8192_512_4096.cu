...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = HgemmAlgorithm1Exact::Gemm;
  using StrideA = HgemmAlgorithm1Exact::StrideA;
  using StrideB = HgemmAlgorithm1Exact::StrideB;
  using StrideC = HgemmAlgorithm1Exact::StrideC;
  using StrideD = HgemmAlgorithm1Exact::StrideD;
  using ElementA = HgemmAlgorithm1Exact::ElementA;
  using ElementB = HgemmAlgorithm1Exact::ElementB;
  using ElementC = HgemmAlgorithm1Exact::ElementC;
...
#else
  throw std::runtime_error("CUTLASS SM90 not supported - H100 required");
#endif
}