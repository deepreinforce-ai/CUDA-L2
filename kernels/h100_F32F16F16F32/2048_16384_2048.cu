...
struct Manual4StageCooperativeHgemmKernel {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = Manual4StageCooperativeHgemmKernel::Gemm;
  using StrideA = Manual4StageCooperativeHgemmKernel::StrideA;
  using StrideB = Manual4StageCooperativeHgemmKernel::StrideB;
  using StrideC = Manual4StageCooperativeHgemmKernel::StrideC;
  using StrideD = Manual4StageCooperativeHgemmKernel::StrideD;
  using ElementA = Manual4StageCooperativeHgemmKernel::ElementA;
  using ElementB = Manual4StageCooperativeHgemmKernel::ElementB;
  using ElementC = Manual4StageCooperativeHgemmKernel::ElementC;
