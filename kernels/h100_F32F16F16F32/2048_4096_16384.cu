...
struct HgemmKernelStableAutoCarveout {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = HgemmKernelStableAutoCarveout::Gemm;
  using StrideA = HgemmKernelStableAutoCarveout::StrideA;
  using StrideB = HgemmKernelStableAutoCarveout::StrideB;
  using StrideC = HgemmKernelStableAutoCarveout::StrideC;
  using StrideD = HgemmKernelStableAutoCarveout::StrideD;
  using ElementA = HgemmKernelStableAutoCarveout::ElementA;
  using ElementB = HgemmKernelStableAutoCarveout::ElementB;
  using ElementC = HgemmKernelStableAutoCarveout::ElementC;
  ...
  typename Gemm::Arguments arguments{
    ...
    {{cutlass::half_t(1.0f), cutlass::half_t(0.0f)}, ptr_C, stride_C, ptr_D, stride_D},
    hw_info
  };
  ...
  if (status != cutlass::Status::kSuccess) {
    throw std::runtime_error("CUTLASS GEMM cannot implement stable auto-carveout configuration");
  }
