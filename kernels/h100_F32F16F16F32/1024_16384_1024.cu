...
struct HgemmValidated {
  ...
  static constexpr int AlignmentA = 32 / sizeof(ElementA);
  static constexpr int AlignmentB = 32 / sizeof(ElementB);
  static constexpr int AlignmentC = 32 / sizeof(ElementC);
  static constexpr int AlignmentD = 32 / sizeof(ElementD);
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmValidated::Gemm;
  using StrideA = typename HgemmValidated::StrideA;
  using StrideB = typename HgemmValidated::StrideB;
  using StrideC = typename HgemmValidated::StrideC;
  using StrideD = typename HgemmValidated::StrideD;
  using ElementA = typename HgemmValidated::ElementA;
  using ElementB = typename HgemmValidated::ElementB;
  using ElementC = typename HgemmValidated::ElementC;
