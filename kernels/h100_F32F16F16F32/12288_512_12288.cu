...
struct HgemmKernelZeroTileCooperative {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmKernelZeroTileCooperative::Gemm;
  using StrideA = typename HgemmKernelZeroTileCooperative::StrideA;
  using StrideB = typename HgemmKernelZeroTileCooperative::StrideB;
  using StrideC = typename HgemmKernelZeroTileCooperative::StrideC;
  using StrideD = typename HgemmKernelZeroTileCooperative::StrideD;
  using ElementA = typename HgemmKernelZeroTileCooperative::ElementA;
  using ElementB = typename HgemmKernelZeroTileCooperative::ElementB;
  using ElementC = typename HgemmKernelZeroTileCooperative::ElementC;
