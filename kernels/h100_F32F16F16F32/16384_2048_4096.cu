...
struct HgemmMaxBandwidthKernel {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename HgemmMaxBandwidthKernel::Gemm;
  using StrideA = typename HgemmMaxBandwidthKernel::StrideA;
  using StrideB = typename HgemmMaxBandwidthKernel::StrideB;
  using StrideC = typename HgemmMaxBandwidthKernel::StrideC;
  using StrideD = typename HgemmMaxBandwidthKernel::StrideD;
  using ElementA = typename HgemmMaxBandwidthKernel::ElementA;
  using ElementB = typename HgemmMaxBandwidthKernel::ElementB;
  using ElementC = typename HgemmMaxBandwidthKernel::ElementC;
