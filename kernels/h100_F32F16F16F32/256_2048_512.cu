...
template <typename T, int BM, int BN, int BK, int kStage, typename TiledMMA,
          ...
          typename S2GCopyC>
__global__ void hgemm_h100_optimized_kernel(T *Aptr, T *Bptr, T *Dptr, int m,
                                            int n, int k) {
...
void launch_hgemm_h100_optimized(T *a, T *b, T *c, int M, int N, int K) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      hgemm_h100_optimized_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA,
  ...
  hgemm_h100_optimized_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA, G2SCopyB,
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_h100_optimized<half, 5>(
