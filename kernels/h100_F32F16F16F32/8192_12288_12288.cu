...
struct HgemmOptimizedKernel {
  ...
  using StageCountType = cute::Int<3>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmOptimizedKernel::Gemm;
  using StrideA = typename HgemmOptimizedKernel::StrideA;
  using StrideB = typename HgemmOptimizedKernel::StrideB;
  using StrideC = typename HgemmOptimizedKernel::StrideC;
  using StrideD = typename HgemmOptimizedKernel::StrideD;
  using ElementA = typename HgemmOptimizedKernel::ElementA;
  using ElementB = typename HgemmOptimizedKernel::ElementB;
  using ElementC = typename HgemmOptimizedKernel::ElementC;
