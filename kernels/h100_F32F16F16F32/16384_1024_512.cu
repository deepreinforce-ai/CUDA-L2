...
struct StandardAutoCarveoutHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = StandardAutoCarveoutHgemmKernel::Gemm;
  using StrideA = StandardAutoCarveoutHgemmKernel::StrideA;
  using StrideB = StandardAutoCarveoutHgemmKernel::StrideB;
  using StrideC = StandardAutoCarveoutHgemmKernel::StrideC;
  using StrideD = StandardAutoCarveoutHgemmKernel::StrideD;
  using ElementA = StandardAutoCarveoutHgemmKernel::ElementA;
  using ElementB = StandardAutoCarveoutHgemmKernel::ElementB;
  using ElementC = StandardAutoCarveoutHgemmKernel::ElementC;
