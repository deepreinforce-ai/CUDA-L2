...
struct OptimizedH100GemmKernel {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = OptimizedH100GemmKernel::Gemm;
  using StrideA = OptimizedH100GemmKernel::StrideA;
  using StrideB = OptimizedH100GemmKernel::StrideB;
  using StrideC = OptimizedH100GemmKernel::StrideC;
  using StrideD = OptimizedH100GemmKernel::StrideD;
  using ElementA = OptimizedH100GemmKernel::ElementA;
  using ElementB = OptimizedH100GemmKernel::ElementB;
  using ElementC = OptimizedH100GemmKernel::ElementC;
  ...
  if (cuda_status != cudaSuccess) {
    std::string err_msg = "CUDA kernel error: ";
...
#else
  throw std::runtime_error("H100 (SM90) architecture required for this optimized kernel");
#endif
}