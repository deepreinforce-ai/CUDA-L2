...
struct SwizzleOptimizedCooperativeKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename SwizzleOptimizedCooperativeKernel::Gemm;
  using StrideA = typename SwizzleOptimizedCooperativeKernel::StrideA;
  using StrideB = typename SwizzleOptimizedCooperativeKernel::StrideB;
  using StrideC = typename SwizzleOptimizedCooperativeKernel::StrideC;
  using StrideD = typename SwizzleOptimizedCooperativeKernel::StrideD;
  using ElementA = typename SwizzleOptimizedCooperativeKernel::ElementA;
  using ElementB = typename SwizzleOptimizedCooperativeKernel::ElementB;
  using ElementC = typename SwizzleOptimizedCooperativeKernel::ElementC;
