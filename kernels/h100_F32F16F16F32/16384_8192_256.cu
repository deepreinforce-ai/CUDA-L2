...
struct BalancedTileHgemmKernel {
  ...
  using EpilogueTileType = cute::Shape<cute::_64, cute::_64>;
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  using Gemm = typename BalancedTileHgemmKernel::Gemm;
  using StrideA = typename BalancedTileHgemmKernel::StrideA;
  using StrideB = typename BalancedTileHgemmKernel::StrideB;
  using StrideC = typename BalancedTileHgemmKernel::StrideC;
  using StrideD = typename BalancedTileHgemmKernel::StrideD;
  using ElementA = typename BalancedTileHgemmKernel::ElementA;
  using ElementB = typename BalancedTileHgemmKernel::ElementB;
  using ElementC = typename BalancedTileHgemmKernel::ElementC;
