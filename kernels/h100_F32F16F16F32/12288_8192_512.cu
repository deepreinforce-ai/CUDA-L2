...
struct HgemmSwizzleOpt {
  ...
  using GridShape = cute::Shape<cute::_4, cute::_2, cute::_1>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmSwizzleOpt::Gemm;
  using StrideA = typename HgemmSwizzleOpt::StrideA;
  using StrideB = typename HgemmSwizzleOpt::StrideB;
  using StrideC = typename HgemmSwizzleOpt::StrideC;
  using StrideD = typename HgemmSwizzleOpt::StrideD;
  using ElementA = typename HgemmSwizzleOpt::ElementA;
  using ElementB = typename HgemmSwizzleOpt::ElementB;
  using ElementC = typename HgemmSwizzleOpt::ElementC;
