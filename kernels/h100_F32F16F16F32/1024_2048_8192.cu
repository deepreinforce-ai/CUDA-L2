...
void gemm_optimized_wgmma_tma_kernel(
...
void launch_hgemm_optimized_wgmma_tma_sm90(
    TA const* A, int ldA,
    TB const* B, int ldB,
    TC* C, int ldC,
    int M, int N, int K)
{
  ...
  auto kernel_ptr = &gemm_optimized_wgmma_tma_kernel<
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  launch_hgemm_optimized_wgmma_tma_sm90<cute::half_t, cute::half_t, cute::half_t>(
