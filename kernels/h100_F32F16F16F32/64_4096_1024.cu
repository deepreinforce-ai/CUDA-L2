...
cuda_l2_h100_fp32_kernel(T * __restrict__ Aptr, T * __restrict__ Bptr,
...
#pragma unroll
  ...
  int total_iterations = size<1>(tCrC_r2sx);

#pragma unroll
  for (int i = 0; i < total_iterations; i += step) {
#pragma unroll
