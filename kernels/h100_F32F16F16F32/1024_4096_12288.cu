...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename OptimalH100Hgemm::Gemm;
  using StrideA = typename OptimalH100Hgemm::StrideA;
  using StrideB = typename OptimalH100Hgemm::StrideB;
  using StrideC = typename OptimalH100Hgemm::StrideC;
  using StrideD = typename OptimalH100Hgemm::StrideD;
  using ElementA = typename OptimalH100Hgemm::ElementA;
  using ElementB = typename OptimalH100Hgemm::ElementB;
  using ElementC = typename OptimalH100Hgemm::ElementC;
