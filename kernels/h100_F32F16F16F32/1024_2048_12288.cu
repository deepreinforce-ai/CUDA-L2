...
struct CooperativeNoSmemHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename CooperativeNoSmemHgemmKernel::Gemm;
  using StrideA = typename CooperativeNoSmemHgemmKernel::StrideA;
  using StrideB = typename CooperativeNoSmemHgemmKernel::StrideB;
  using StrideC = typename CooperativeNoSmemHgemmKernel::StrideC;
  using StrideD = typename CooperativeNoSmemHgemmKernel::StrideD;
  using ElementA = typename CooperativeNoSmemHgemmKernel::ElementA;
  using ElementB = typename CooperativeNoSmemHgemmKernel::ElementB;
  using ElementC = typename CooperativeNoSmemHgemmKernel::ElementC;
