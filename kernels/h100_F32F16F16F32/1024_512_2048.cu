...
__global__ void __launch_bounds__(64, 4)
  ...
  constexpr int kPipelineDepth = kStage - 1;
  
#pragma unroll
  for (int istage = 0; istage < kPipelineDepth; ++istage) {
...
void launch_hgemm_optimal_6stage(T *a, T *b, T *c, int M, int N, int K,
                                  int swizzle_stride) {
  using namespace cute;
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_optimal_6stage<half, 6>(
