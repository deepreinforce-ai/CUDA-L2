...
struct HgemmProven5StageExplicitEpilogue {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmProven5StageExplicitEpilogue::Gemm;
  using StrideA = typename HgemmProven5StageExplicitEpilogue::StrideA;
  using StrideB = typename HgemmProven5StageExplicitEpilogue::StrideB;
  using StrideC = typename HgemmProven5StageExplicitEpilogue::StrideC;
  using StrideD = typename HgemmProven5StageExplicitEpilogue::StrideD;
  using ElementA = typename HgemmProven5StageExplicitEpilogue::ElementA;
  using ElementB = typename HgemmProven5StageExplicitEpilogue::ElementB;
  using ElementC = typename HgemmProven5StageExplicitEpilogue::ElementC;
