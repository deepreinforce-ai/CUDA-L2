...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename HgemmExplicitStages::Gemm;
  using StrideA = typename HgemmExplicitStages::StrideA;
  using StrideB = typename HgemmExplicitStages::StrideB;
  using StrideC = typename HgemmExplicitStages::StrideC;
  using StrideD = typename HgemmExplicitStages::StrideD;
  using ElementA = typename HgemmExplicitStages::ElementA;
  using ElementB = typename HgemmExplicitStages::ElementB;
  using ElementC = typename HgemmExplicitStages::ElementC;
