...
struct HgemmAsymmetricTileGroup {
  ...
  using TileGroupShape = cute::Shape<cute::_1, cute::_4, cute::_1>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmAsymmetricTileGroup::Gemm;
  using StrideA = typename HgemmAsymmetricTileGroup::StrideA;
  using StrideB = typename HgemmAsymmetricTileGroup::StrideB;
  using StrideC = typename HgemmAsymmetricTileGroup::StrideC;
  using StrideD = typename HgemmAsymmetricTileGroup::StrideD;
  using ElementA = typename HgemmAsymmetricTileGroup::ElementA;
  using ElementB = typename HgemmAsymmetricTileGroup::ElementB;
  using ElementC = typename HgemmAsymmetricTileGroup::ElementC;
