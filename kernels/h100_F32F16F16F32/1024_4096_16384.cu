...
struct UltraDeepPipelineHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename UltraDeepPipelineHgemmKernel::Gemm;
  using StrideA = typename UltraDeepPipelineHgemmKernel::StrideA;
  using StrideB = typename UltraDeepPipelineHgemmKernel::StrideB;
  using StrideC = typename UltraDeepPipelineHgemmKernel::StrideC;
  using StrideD = typename UltraDeepPipelineHgemmKernel::StrideD;
  using ElementA = typename UltraDeepPipelineHgemmKernel::ElementA;
  using ElementB = typename UltraDeepPipelineHgemmKernel::ElementB;
  using ElementC = typename UltraDeepPipelineHgemmKernel::ElementC;
