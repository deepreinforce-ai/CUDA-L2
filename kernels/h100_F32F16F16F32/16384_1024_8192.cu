...
struct ExtremeSingleStageKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = ExtremeSingleStageKernel::Gemm;
  using StrideA = ExtremeSingleStageKernel::StrideA;
  using StrideB = ExtremeSingleStageKernel::StrideB;
  using StrideC = ExtremeSingleStageKernel::StrideC;
  using StrideD = ExtremeSingleStageKernel::StrideD;
  using ElementA = ExtremeSingleStageKernel::ElementA;
  using ElementB = ExtremeSingleStageKernel::ElementB;
  using ElementC = ExtremeSingleStageKernel::ElementC;
