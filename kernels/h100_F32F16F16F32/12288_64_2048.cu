...
hgemm_wgmma_ultimate_kernel(const T *__restrict__ Aptr,
...
void launch_optimized_wgmma_ultimate(T *a, T *b, T *c, int M, int N, int K,
                                     int swizzle_stride) {
  using namespace cute;
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_optimized_wgmma_ultimate<half, 6, true>(
