...
struct HgemmEnhanced5Stage {
  ...
  using StageCountType = cutlass::gemm::collective::StageCountAutoCarveout<Stages>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmEnhanced5Stage::Gemm;
  using StrideA = typename HgemmEnhanced5Stage::StrideA;
  using StrideB = typename HgemmEnhanced5Stage::StrideB;
  using StrideC = typename HgemmEnhanced5Stage::StrideC;
  using StrideD = typename HgemmEnhanced5Stage::StrideD;
  using ElementA = typename HgemmEnhanced5Stage::ElementA;
  using ElementB = typename HgemmEnhanced5Stage::ElementB;
  using ElementC = typename HgemmEnhanced5Stage::ElementC;
