...
using PreEpilogue = typename cutlass::epilogue::collective::CollectiveBuilder<
...
using StageCountType = cutlass::gemm::collective::StageCountAutoCarveout<
    static_cast<int>(sizeof(typename PreEpilogue::SharedStorage))>;

using KernelSchedule = cutlass::gemm::KernelTmaWarpSpecializedCooperative;

using CollectiveEpilogue = PreEpilogue;
