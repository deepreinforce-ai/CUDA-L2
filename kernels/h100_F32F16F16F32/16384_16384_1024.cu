...
struct Hgemm3StageCooperative {
  ...
  using WorkGroupShape = cute::Shape<cute::_2, cute::_1, cute::_1>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename Hgemm3StageCooperative::Gemm;
  using StrideA = typename Hgemm3StageCooperative::StrideA;
  using StrideB = typename Hgemm3StageCooperative::StrideB;
  using StrideC = typename Hgemm3StageCooperative::StrideC;
  using StrideD = typename Hgemm3StageCooperative::StrideD;
  using ElementA = typename Hgemm3StageCooperative::ElementA;
  using ElementB = typename Hgemm3StageCooperative::ElementB;
  using ElementC = typename Hgemm3StageCooperative::ElementC;
...
#else
  throw std::runtime_error("CUTLASS SM90 not supported - requires H100 or newer");
#endif
}