...
struct SafeOptimizedHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = SafeOptimizedHgemmKernel::Gemm;
  using StrideA = SafeOptimizedHgemmKernel::StrideA;
  using StrideB = SafeOptimizedHgemmKernel::StrideB;
  using StrideC = SafeOptimizedHgemmKernel::StrideC;
  using StrideD = SafeOptimizedHgemmKernel::StrideD;
  using ElementA = SafeOptimizedHgemmKernel::ElementA;
  using ElementB = SafeOptimizedHgemmKernel::ElementB;
  using ElementC = SafeOptimizedHgemmKernel::ElementC;
