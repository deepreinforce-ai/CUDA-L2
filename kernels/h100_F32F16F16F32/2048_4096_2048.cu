...
struct RefinedStableHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename RefinedStableHgemmKernel::Gemm;
  using StrideA = typename RefinedStableHgemmKernel::StrideA;
  using StrideB = typename RefinedStableHgemmKernel::StrideB;
  using StrideC = typename RefinedStableHgemmKernel::StrideC;
  using StrideD = typename RefinedStableHgemmKernel::StrideD;
  using ElementA = typename RefinedStableHgemmKernel::ElementA;
  using ElementB = typename RefinedStableHgemmKernel::ElementB;
  using ElementC = typename RefinedStableHgemmKernel::ElementC;
