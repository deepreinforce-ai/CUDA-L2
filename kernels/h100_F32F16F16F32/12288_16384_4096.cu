...
struct HgemmLargeTileOptimized {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmLargeTileOptimized::Gemm;
  using StrideA = typename HgemmLargeTileOptimized::StrideA;
  using StrideB = typename HgemmLargeTileOptimized::StrideB;
  using StrideC = typename HgemmLargeTileOptimized::StrideC;
  using StrideD = typename HgemmLargeTileOptimized::StrideD;
  using ElementA = typename HgemmLargeTileOptimized::ElementA;
  using ElementB = typename HgemmLargeTileOptimized::ElementB;
  using ElementC = typename HgemmLargeTileOptimized::ElementC;
