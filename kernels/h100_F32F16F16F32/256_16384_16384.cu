...
struct HgemmTmaCooperativeEpilogue {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmTmaCooperativeEpilogue::Gemm;
  using StrideA = typename HgemmTmaCooperativeEpilogue::StrideA;
  using StrideB = typename HgemmTmaCooperativeEpilogue::StrideB;
  using StrideC = typename HgemmTmaCooperativeEpilogue::StrideC;
  using StrideD = typename HgemmTmaCooperativeEpilogue::StrideD;
  using ElementA = typename HgemmTmaCooperativeEpilogue::ElementA;
  using ElementB = typename HgemmTmaCooperativeEpilogue::ElementB;
  using ElementC = typename HgemmTmaCooperativeEpilogue::ElementC;
