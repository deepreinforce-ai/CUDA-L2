...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename HgemmNoTileGroupH100::Gemm;
  using StrideA = typename HgemmNoTileGroupH100::StrideA;
  using StrideB = typename HgemmNoTileGroupH100::StrideB;
  using StrideC = typename HgemmNoTileGroupH100::StrideC;
  using StrideD = typename HgemmNoTileGroupH100::StrideD;
  using ElementA = typename HgemmNoTileGroupH100::ElementA;
  using ElementB = typename HgemmNoTileGroupH100::ElementB;
  using ElementC = typename HgemmNoTileGroupH100::ElementC;
