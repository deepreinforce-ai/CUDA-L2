...
struct Explicit4StageHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = Explicit4StageHgemmKernel::Gemm;
  using StrideA = Explicit4StageHgemmKernel::StrideA;
  using StrideB = Explicit4StageHgemmKernel::StrideB;
  using StrideC = Explicit4StageHgemmKernel::StrideC;
  using StrideD = Explicit4StageHgemmKernel::StrideD;
  using ElementA = Explicit4StageHgemmKernel::ElementA;
  using ElementB = Explicit4StageHgemmKernel::ElementB;
  using ElementC = Explicit4StageHgemmKernel::ElementC;
