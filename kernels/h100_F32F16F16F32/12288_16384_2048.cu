...
struct HgemmNDimensionOptimized {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = HgemmNDimensionOptimized::Gemm;
  using StrideA = HgemmNDimensionOptimized::StrideA;
  using StrideB = HgemmNDimensionOptimized::StrideB;
  using StrideC = HgemmNDimensionOptimized::StrideC;
  using StrideD = HgemmNDimensionOptimized::StrideD;
  using ElementA = HgemmNDimensionOptimized::ElementA;
  using ElementB = HgemmNDimensionOptimized::ElementB;
  using ElementC = HgemmNDimensionOptimized::ElementC;
