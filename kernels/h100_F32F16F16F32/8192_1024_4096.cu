...
struct HgemmProvenAlgorithm1Kernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmProvenAlgorithm1Kernel::Gemm;
  using StrideA = typename HgemmProvenAlgorithm1Kernel::StrideA;
  using StrideB = typename HgemmProvenAlgorithm1Kernel::StrideB;
  using StrideC = typename HgemmProvenAlgorithm1Kernel::StrideC;
  using StrideD = typename HgemmProvenAlgorithm1Kernel::StrideD;
  using ElementA = typename HgemmProvenAlgorithm1Kernel::ElementA;
  using ElementB = typename HgemmProvenAlgorithm1Kernel::ElementB;
  using ElementC = typename HgemmProvenAlgorithm1Kernel::ElementC;
