...
struct MegaTileFP16HgemmKernel {
  ...
  using WorkGroupShape = cute::Shape<cute::_2, cute::_2, cute::_1>;
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = MegaTileFP16HgemmKernel::Gemm;
  using StrideA = MegaTileFP16HgemmKernel::StrideA;
  using StrideB = MegaTileFP16HgemmKernel::StrideB;
  using StrideC = MegaTileFP16HgemmKernel::StrideC;
  using StrideD = MegaTileFP16HgemmKernel::StrideD;
  using ElementA = MegaTileFP16HgemmKernel::ElementA;
  using ElementB = MegaTileFP16HgemmKernel::ElementB;
  using ElementC = MegaTileFP16HgemmKernel::ElementC;
