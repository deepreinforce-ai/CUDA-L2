...
hgemm_h100_conservative_kernel(T *Aptr, T *Bptr, T *Dptr, int m, int n, int k) {
...
template <typename T>
void launch_hgemm_h100_conservative(T *a, T *b, T *c, int M, int N, int K) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      hgemm_h100_conservative_kernel<
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  launch_hgemm_h100_conservative<half>(
