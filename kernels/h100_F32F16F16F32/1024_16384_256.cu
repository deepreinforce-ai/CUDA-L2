...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = ProvenCorrectKernel::Gemm;
  using StrideA = ProvenCorrectKernel::StrideA;
  using StrideB = ProvenCorrectKernel::StrideB;
  using StrideC = ProvenCorrectKernel::StrideC;
  using StrideD = ProvenCorrectKernel::StrideD;
  using ElementA = ProvenCorrectKernel::ElementA;
  using ElementB = ProvenCorrectKernel::ElementB;
  using ElementC = ProvenCorrectKernel::ElementC;
