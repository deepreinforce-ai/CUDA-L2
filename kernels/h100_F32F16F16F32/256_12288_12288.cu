...
struct FourStageCooperativeRowMajorBHgemm {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename FourStageCooperativeRowMajorBHgemm::Gemm;
  using StrideA = typename FourStageCooperativeRowMajorBHgemm::StrideA;
  using StrideB = typename FourStageCooperativeRowMajorBHgemm::StrideB;
  using StrideC = typename FourStageCooperativeRowMajorBHgemm::StrideC;
  using StrideD = typename FourStageCooperativeRowMajorBHgemm::StrideD;
  using ElementA = typename FourStageCooperativeRowMajorBHgemm::ElementA;
  using ElementB = typename FourStageCooperativeRowMajorBHgemm::ElementB;
  using ElementC = typename FourStageCooperativeRowMajorBHgemm::ElementC;
  ...
  auto* ptr_B = reinterpret_cast<ElementB*>(b.data_ptr());
