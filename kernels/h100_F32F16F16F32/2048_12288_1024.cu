...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = StreamKOptimizedKernel::Gemm;
  using StrideA = StreamKOptimizedKernel::StrideA;
  using StrideB = StreamKOptimizedKernel::StrideB;
  using StrideC = StreamKOptimizedKernel::StrideC;
  using StrideD = StreamKOptimizedKernel::StrideD;
  using ElementA = StreamKOptimizedKernel::ElementA;
  using ElementB = StreamKOptimizedKernel::ElementB;
  using ElementC = StreamKOptimizedKernel::ElementC;
