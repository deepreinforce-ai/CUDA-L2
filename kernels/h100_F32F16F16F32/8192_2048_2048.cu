...
struct HgemmPreciseMinimalConfig {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmPreciseMinimalConfig::Gemm;
  using StrideA = typename HgemmPreciseMinimalConfig::StrideA;
  using StrideB = typename HgemmPreciseMinimalConfig::StrideB;
  using StrideC = typename HgemmPreciseMinimalConfig::StrideC;
  using StrideD = typename HgemmPreciseMinimalConfig::StrideD;
  using ElementA = typename HgemmPreciseMinimalConfig::ElementA;
  using ElementB = typename HgemmPreciseMinimalConfig::ElementB;
  using ElementC = typename HgemmPreciseMinimalConfig::ElementC;
