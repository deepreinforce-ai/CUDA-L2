...
struct PrecisionTuned4StageHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = PrecisionTuned4StageHgemmKernel::Gemm;
  using StrideA = PrecisionTuned4StageHgemmKernel::StrideA;
  using StrideB = PrecisionTuned4StageHgemmKernel::StrideB;
  using StrideC = PrecisionTuned4StageHgemmKernel::StrideC;
  using StrideD = PrecisionTuned4StageHgemmKernel::StrideD;
  using ElementA = PrecisionTuned4StageHgemmKernel::ElementA;
  using ElementB = PrecisionTuned4StageHgemmKernel::ElementB;
  using ElementC = PrecisionTuned4StageHgemmKernel::ElementC;
