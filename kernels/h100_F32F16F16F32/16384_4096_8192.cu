...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename HgemmH100Optimized::Gemm;
  using StrideA = typename HgemmH100Optimized::StrideA;
  using StrideB = typename HgemmH100Optimized::StrideB;
  using StrideC = typename HgemmH100Optimized::StrideC;
  using StrideD = typename HgemmH100Optimized::StrideD;
  using ElementA = typename HgemmH100Optimized::ElementA;
  using ElementB = typename HgemmH100Optimized::ElementB;
  using ElementC = typename HgemmH100Optimized::ElementC;
...
#else
  throw std::runtime_error("CUTLASS SM90 (H100) architecture not supported on this device");
#endif
}