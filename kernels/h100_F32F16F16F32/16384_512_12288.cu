...
struct SM90CooperativeGemmConfig {
...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  using Gemm = typename SM90CooperativeGemmConfig::Gemm;
  using StrideA = typename SM90CooperativeGemmConfig::StrideA;
  using StrideB = typename SM90CooperativeGemmConfig::StrideB;
  using StrideC = typename SM90CooperativeGemmConfig::StrideC;
  using StrideD = typename SM90CooperativeGemmConfig::StrideD;
  using ElementA = typename SM90CooperativeGemmConfig::ElementA;
  using ElementB = typename SM90CooperativeGemmConfig::ElementB;
  using ElementC = typename SM90CooperativeGemmConfig::ElementC;
