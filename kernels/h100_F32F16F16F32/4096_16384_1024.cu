...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HgemmH100UltraWideN::Gemm;
  using StrideA = typename HgemmH100UltraWideN::StrideA;
  using StrideB = typename HgemmH100UltraWideN::StrideB;
  using StrideC = typename HgemmH100UltraWideN::StrideC;
  using StrideD = typename HgemmH100UltraWideN::StrideD;
  using ElementA = typename HgemmH100UltraWideN::ElementA;
  using ElementB = typename HgemmH100UltraWideN::ElementB;
  using ElementC = typename HgemmH100UltraWideN::ElementC;
