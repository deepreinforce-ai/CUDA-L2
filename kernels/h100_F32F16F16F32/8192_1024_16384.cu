...
struct HyperOptimizedWarpSpecializedHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename HyperOptimizedWarpSpecializedHgemmKernel::Gemm;
  using StrideA = typename HyperOptimizedWarpSpecializedHgemmKernel::StrideA;
  using StrideB = typename HyperOptimizedWarpSpecializedHgemmKernel::StrideB;
  using StrideC = typename HyperOptimizedWarpSpecializedHgemmKernel::StrideC;
  using StrideD = typename HyperOptimizedWarpSpecializedHgemmKernel::StrideD;
  using ElementA = typename HyperOptimizedWarpSpecializedHgemmKernel::ElementA;
  using ElementB = typename HyperOptimizedWarpSpecializedHgemmKernel::ElementB;
  using ElementC = typename HyperOptimizedWarpSpecializedHgemmKernel::ElementC;
