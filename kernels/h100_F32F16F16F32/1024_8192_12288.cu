...
struct EnhancedPipelineHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = EnhancedPipelineHgemmKernel::Gemm;
  using StrideA = EnhancedPipelineHgemmKernel::StrideA;
  using StrideB = EnhancedPipelineHgemmKernel::StrideB;
  using StrideC = EnhancedPipelineHgemmKernel::StrideC;
  using StrideD = EnhancedPipelineHgemmKernel::StrideD;
  using ElementA = EnhancedPipelineHgemmKernel::ElementA;
  using ElementB = EnhancedPipelineHgemmKernel::ElementB;
  using ElementC = EnhancedPipelineHgemmKernel::ElementC;
