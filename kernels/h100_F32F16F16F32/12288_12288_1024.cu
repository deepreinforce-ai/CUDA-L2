...
void cuda_l2_h100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  using Gemm = HgemmOptimized::Gemm;
  using StrideA = HgemmOptimized::StrideA;
  using StrideB = HgemmOptimized::StrideB;
  using StrideC = HgemmOptimized::StrideC;
  using StrideD = HgemmOptimized::StrideD;
  using ElementA = HgemmOptimized::ElementA;
  using ElementB = HgemmOptimized::ElementB;
  using ElementC = HgemmOptimized::ElementC;
