...
struct ExplicitPipelineHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename ExplicitPipelineHgemmKernel::Gemm;
  using StrideA = typename ExplicitPipelineHgemmKernel::StrideA;
  using StrideB = typename ExplicitPipelineHgemmKernel::StrideB;
  using StrideC = typename ExplicitPipelineHgemmKernel::StrideC;
  using StrideD = typename ExplicitPipelineHgemmKernel::StrideD;
  using ElementA = typename ExplicitPipelineHgemmKernel::ElementA;
  using ElementB = typename ExplicitPipelineHgemmKernel::ElementB;
  using ElementC = typename ExplicitPipelineHgemmKernel::ElementC;
