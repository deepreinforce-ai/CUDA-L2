...
struct OptimizedAutoStageKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = OptimizedAutoStageKernel::Gemm;
  using StrideA = OptimizedAutoStageKernel::StrideA;
  using StrideB = OptimizedAutoStageKernel::StrideB;
  using StrideC = OptimizedAutoStageKernel::StrideC;
  using StrideD = OptimizedAutoStageKernel::StrideD;
  using ElementA = OptimizedAutoStageKernel::ElementA;
  using ElementB = OptimizedAutoStageKernel::ElementB;
  using ElementC = OptimizedAutoStageKernel::ElementC;
