...
struct StableAutoCarveoutHgemmKernel {
...
#if defined(CUTLASS_ARCH_MMA_SM90_SUPPORTED)
  using Gemm = typename StableAutoCarveoutHgemmKernel::Gemm;
  using StrideA = typename StableAutoCarveoutHgemmKernel::StrideA;
  using StrideB = typename StableAutoCarveoutHgemmKernel::StrideB;
  using StrideC = typename StableAutoCarveoutHgemmKernel::StrideC;
  using StrideD = typename StableAutoCarveoutHgemmKernel::StrideD;
  using ElementA = typename StableAutoCarveoutHgemmKernel::ElementA;
  using ElementB = typename StableAutoCarveoutHgemmKernel::ElementB;
  using ElementC = typename StableAutoCarveoutHgemmKernel::ElementC;
