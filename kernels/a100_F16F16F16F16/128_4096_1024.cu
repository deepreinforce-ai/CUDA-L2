...
cuda_l2_a100_fp16_kernel(T *Aptr, T *Bptr, T *Dptr, int m,
  ...
  int ik = 0;
  cute::copy(s2r_tiled_copy_a, tAsA_s2r(_, _, ik, ismem_read), tCrA_view(_, _, ik));
  cute::copy(s2r_tiled_copy_b, tBsB_s2r(_, _, ik, ismem_read), tCrB_view(_, _, ik));
