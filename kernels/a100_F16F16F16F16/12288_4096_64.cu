...
template <typename T, const int Stages = 1, const bool BlockSwizzle = true>
...
void cuda_l2_a100_fp16(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_mma_stages_block_swizzle_tn_cute<half, 1, true>(
