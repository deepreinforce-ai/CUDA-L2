...
template <typename T>
void launch_hgemm_cute(T *a, T *b, T *c, int M, int N, int K) {
  using namespace cute;
  ...
  using S2RCopyAtomA = Copy_Atom<UniversalCopy<int>, T>;
  using S2RCopyAtomB = Copy_Atom<UniversalCopy<int>, T>;
