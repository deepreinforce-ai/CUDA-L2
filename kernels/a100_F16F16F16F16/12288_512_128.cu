...
#pragma unroll
  ...
  cute::copy(g2s_tiled_copy_a, tAgA_copy(_, _, _, 2), tAsA_copy(_, _, _, 0));
  cute::copy(g2s_tiled_copy_b, tBgB_copy(_, _, _, 2), tBsB_copy(_, _, _, 0));
  cp_async_fence();
...
#pragma unroll
  ...
  cute::copy(g2s_tiled_copy_a, tAgA_copy(_, _, _, 3), tAsA_copy(_, _, _, 1));
  cute::copy(g2s_tiled_copy_b, tBgB_copy(_, _, _, 3), tBsB_copy(_, _, _, 1));
  cp_async_fence();
