...
void launch_hgemm_mma_stages_block_swizzle_tn_cute(T *a, T *b, T *c, int M,
  ...
  using SmemLayoutA = decltype(tile_to_shape(
      SmemLayoutAtom{}, make_shape(Int<BM>{}, Int<BK>{}, Int<4>{})));
  using SmemLayoutB = decltype(tile_to_shape(
      SmemLayoutAtom{}, make_shape(Int<BN>{}, Int<BK>{}, Int<4>{})));
  ...
  cudaFuncSetAttribute(
      cuda_l2_a100_fp32_kernel<
          T, BM, BN, BK, 4, MMA, G2SCopyA, G2SCopyB, SmemLayoutA,
  ...
  cuda_l2_a100_fp32_kernel<
      T, BM, BN, BK, 4, MMA, G2SCopyA, G2SCopyB, SmemLayoutA, SmemLayoutB,
