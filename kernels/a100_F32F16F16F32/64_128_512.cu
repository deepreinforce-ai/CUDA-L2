...
cuda_l2_a100_fp32_kernel(const T * __restrict__ Aptr,
  ...
  register int itile_to_read = 0;
  register int ismem_read = 0;
  register int ismem_write = 0;
...
template <typename T, const int Stages>
__host__ __forceinline__
void launch_hgemm_mma_stages_block_swizzle_tn_cute(const T * __restrict__ a,
                                                   const T * __restrict__ b,
                                                   T * __restrict__ c,
                                                   const int M, const int N,
                                                   const int K,
                                                   const int swizzle_stride) {
  using namespace cute;
...
void cuda_l2_a100_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_mma_stages_block_swizzle_tn_cute<half, stages>(
