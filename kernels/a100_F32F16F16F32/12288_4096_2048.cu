...
void launch_hgemm_mma_stages_block_swizzle_tn_cute(half *a, half *b, half *c, int M,
                                                   int N, int K,
                                                   int swizzle_stride) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      cuda_l2_a100_fp32_kernel<
          half, BM, BN, BK, 3, MMA, G2SCopyA, G2SCopyB, SmemLayoutA,
          SmemLayoutB, SmemLayoutC, S2RCopyAtomA, S2RCopyAtomB, R2SCopyAtomC,
          S2GCopyAtomC, S2GCopyC>,
      cudaFuncAttributeMaxDynamicSharedMemorySize, shm_size);

  cuda_l2_a100_fp32_kernel<
      half, BM, BN, BK, 3, MMA, G2SCopyA, G2SCopyB, SmemLayoutA, SmemLayoutB,
