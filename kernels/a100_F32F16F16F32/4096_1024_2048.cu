...
void cuda_l2_a100_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  cudaFuncSetAttribute(
      cuda_l2_a100_fp32_kernel<
          half, BM, BN, BK, KStage, MMA, G2SCopyA, G2SCopyB, SmemLayoutA,
  ...
  cuda_l2_a100_fp32_kernel<
      half, BM, BN, BK, KStage, MMA, G2SCopyA, G2SCopyB, SmemLayoutA, SmemLayoutB,
      SmemLayoutC, S2RCopyAtomA, S2RCopyAtomB, R2SCopyAtomC, S2GCopyAtomC,
      S2GCopyC, true><<<grid, block, kShmSize>>>(
