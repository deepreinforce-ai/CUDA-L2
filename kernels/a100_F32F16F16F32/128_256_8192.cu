...
void launch_hgemm_optimized(T *a, T *b, T *c, int M, int N, int K) {
  ...
  using G2SCopyA = decltype(make_tiled_copy(
      g2s_copy_atom{},
      make_layout(make_shape(Int<16>{}, Int<4>{}), make_stride(Int<4>{}, Int<1>{})),
  ...
  cudaFuncSetAttribute(
      cuda_l2_a100_fp32_kernel<T, BM, BN, BK, KStage, MMA, G2SCopyA, G2SCopyB, SmemLayoutA, SmemLayoutB, SmemLayoutC, S2RCopyAtomA, S2RCopyAtomB, R2SCopyAtomC, S2GCopyAtomC, S2GCopyC>,
