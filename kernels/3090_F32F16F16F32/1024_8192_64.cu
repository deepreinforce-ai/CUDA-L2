...
void cuda_l2_3090_fp32(torch::Tensor a, torch::Tensor b, 
  ...
  cudaFuncSetAttribute(
      cuda_l2_3090_fp32_kernel<
          T, 128, 128, 32, 3, MMA, G2SCopyA, G2SCopyB, SmemLayoutA,
  ...
  cuda_l2_3090_fp32_kernel<
      T, 128, 128, 32, 3, MMA, G2SCopyA, G2SCopyB, SmemLayoutA, SmemLayoutB,
      ...
      reinterpret_cast<T*>(b_col_major.data_ptr()),
      reinterpret_cast<T*>(c.data_ptr()), M, N, K);
}