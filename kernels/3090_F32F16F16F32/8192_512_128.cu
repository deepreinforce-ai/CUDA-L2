...
void launch_hgemm_64x64(T *a, T *b, T *c, int M, int N, int K) {
  using namespace cute;
  ...
  cudaFuncSetAttribute(
      cuda_l2_3090_fp32_kernel<T, BM, BN, BK, KStage, MMA,
...
void cuda_l2_3090_fp32(torch::Tensor a, torch::Tensor b,
  ...
  launch_hgemm_64x64<half, 3>(a_ptr, b_col_ptr, c_ptr, M, N, K);
}